(custom-set-variables
 ...
 '(ansi-color-names-vector
   ["black" "red3" "green3" "yellow3" "DarkOrchid2" "magenta3" "cyan3" "gray90"])
 '(custom-safe-themes
   (quote
...
(custom-set-faces
 ...
 '(font-lock-warning-face ((t (:inherit default :foreground "red2"))))
 '(org-block ((t (:inherit shadow :foreground "orange"))))
